...
cad_icone = PhotoImage(file='C:\\Users\\willa\\Desktop\\Alunos_tkinter_200-main\\icon.png')
atualizar_icone = PhotoImage(file='C:\\Users\\willa\\Desktop\\Alunos_tkinter_200-main\\atualizar.png')
deletar_icone = PhotoImage(file='C:\\Users\\willa\\Desktop\\Alunos_tkinter_200-main\\deletar.png')
pesquisar_icone = PhotoImage(file='C:\\Users\\willa\\Desktop\\Alunos_tkinter_200-main\\pesquisar.png')
resetar_icone = PhotoImage(file='C:\\Users\\willa\\Desktop\\Alunos_tkinter_200-main\\resetar.png')
selecionar_icone = PhotoImage(file='C:\\Users\\willa\\Desktop\\Alunos_tkinter_200-main\\selecionar.png')
...
def cadastrar():
    ...
    if (estid == "" or estid == " ") or (nome == "" or nome == " ") or (s_nome == "" or s_nome == " ") or (endereco == "" or endereco == " ") or (telefone == "" or telefone == " "):
        ...
        try:
            conn = connection()
            cursor = conn.cursor()
            cursor.execute("INSERT INTO FILIADOS VALUES ('"+estid+"','"+nome+"','"+s_nome+"','"+endereco+"','"+telefone+"') ")
            conn.commit()
            conn.close()
           
            
        except:
            messagebox.showinfo("Error", "ESTE Filiado JA EXISTE NO BANCO DE DADOS COM ESTE ID")
            return
...
def pesquisar():
    ...
    conn = connection()
    cursor = conn.cursor()
    cursor.execute("SELECT * FROM Filiados WHERE CPF='"+
    estid+"' or NOME='"+
    nome+"' or S_NOME='"+
    s_nome+"' or ENDERECO='"+
...
def atualizar():
    ...
    if (estid == "" or estid == " ") or (nome == "" or nome == " ") or (s_nome == "" or s_nome == " ") or (endereco == "" or endereco == " ") or (telefone == "" or telefone == " "):
        ...
        try:
            conn = connection()
            cursor = conn.cursor()
            cursor.execute("UPDATE Filiados SET ESTID='"+
            estid+"', NOME='"+
            nome+"', S_NOME='"+
            s_nome+"', ENDERECO='"+
            endereco+"', TELEFONE='"+
